    ...
    <Fragment>
      {projects.slice(0, 3).map((project, index) => (
        ...
        >
          ...
          >
            <h2 className="text-5xl font-extrabold whitespace-nowrap leading-normal">{project.title}</h2>
            ...
            >
              <Link href={project.link} target="_blank">
                <Button
                  type="button"
                  variant="primary"
                  className="hover:text-black bg-black dark:hover:text-white text-white hover:bg-transparent whitespace-nowrap"
                >
                  View Project
                </Button>
              </Link>
